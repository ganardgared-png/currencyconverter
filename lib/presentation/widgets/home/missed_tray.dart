...
class MissedTray extends StatelessWidget {
  const MissedTray({super.key});
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const PaymentListScreen(filter: 'missed'),
              ),
            );
          },
          child: Container(
              ...
              child: isLoading
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        Text(
                          total > 0 ? 'TZS ${total.toStringAsFixed(0)}' : 'No missed',
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                          ),
